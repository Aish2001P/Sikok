...
const footer = () => {
    return (
        <>
            ...
            <section className="lg:px-[60px] px-[20px]  overflow-hidden bg-[#070707] text-[#fff] lg:pt-[40px] pt-[40px] lg:pb-[0px] pb-[20px] ">
                    ...
                    <div className="row items-center">
                        ...
                        <div className="col-lg-5 lg:pt-[0px] pt-[30px]">
                            <ScrollReveal animation="fadeUp" delay={0.4}>
                                ...
                                <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.2vw] leading-[4vw] font-[th] tracking-widest uppercase lg:pt-[40px] pt-[20px]">E-MAIL: sikok@gmail.com</p>
                                ...
                                <div className="lg:flex lg:pt-[100px] pt-[40px]">
                                    ...
                                    <div className="col-lg-9">
                                        ...
                                        <p className="lg:text-[0.9vw] text-[3vw] lg:leading-[1.2vw] leading-[4vw] font-[th] tracking-widest uppercase lg:pt-[20px] pt-[10px] ">PRIVACy POLICy</p>
                                         <Link href="https://www.scriptstudio.in/" className='text-white'>
