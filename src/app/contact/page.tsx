...
export default function Home() {
    return (
        <>
            ...
            <section className="lg:px-[60px] px-[20px]  overflow-hidden bg-[#070707] text-[#fff] lg:pt-[150px] pt-[150px] lg:pb-[60px] pb-[10px] ">
                <div className="row">
            ...
            <section className="lg:px-[60px] px-[20px]  overflow-hidden bg-[#070707] text-[#fff] lg:pt-[60px] pt-[0px] lg:pb-[100px] pb-[40px] ">
                <div className="row">
                    <div className="col-lg-7">
                        <div className="col-lg-8">
                            <ScrollReveal animation="fadeUp" delay={0.2}>
                                <p className="lg:text-[4vw] text-[6vw] lg:leading-[5vw] leading-[7vw] font-[th] text-[#A1A1A1] tracking-wide">Get in touch today and lets create something amazing together</p>
                            </ScrollReveal>
                        </div>
                    </div>
